...
y_test_rf = rf_pipe.predict(X_test)

print("Test set results for Random Forest:")
print(classification_report(y_test, y_test_rf))
print("Confusion matrix:\n", confusion_matrix(y_test, y_test_rf))

acc    = accuracy_score(y_test, y_test_rf)
prec   = precision_score(y_test, y_test_rf)       
rec    = recall_score(y_test, y_test_rf)
...
def predict_fn(data_array):
    ...
    return rf_pipe.predict_proba(df)
